As we need to develop website which supports IE8, and with the ant design, I decided to develop a sort of plugins based on bootstrap 3.3.7 and jquery 1.12.4 to fufill the demands.
